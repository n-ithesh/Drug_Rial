            ...
            <div class="row">
              ...
              <div class="card">
                  <div class="card-body bg-secondary">
                    ...
                    <form class="forms-sample" action="controller/employee.php" method="post">
                      ...
                      <div class="d-flex" style="gap: 20px;">
                        <div class="form-group w-100">
                            ...
                            <input required type="number" class="form-control" id="exampleInputUsername1" placeholder="Phone" name="phone"/>
                        </div>
                        <div class="form-group w-100">
                      ...
                      <div class="form-group w-50">
                            ...
                            <input required type="text" class="form-control" id="exampleInputPassword1" placeholder="Address" name="add" />
                        </div>
                      
                      
                      
                      <button style="float: right;" type="submit" class="btn btn-primary ml-2" name="sub"> Submit </button>
                      <button style="float: right;" class="btn btn-light" name="add">Cancel</button>
                    </form>
                  </div>
                </div>
            </div>
