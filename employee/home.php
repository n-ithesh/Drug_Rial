...
$aid=$_SESSION['e_id'];
$stmt=$admin->ret("SELECT * FROM `employee` where `e_id`='$aid'");
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"><?php echo $row['e_name']; ?></span>
              </h3>
            </div>
            <div class="row">
              <div class="col-xl-4 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <?php
                      $stmt2=$admin->ret("SELECT * FROM `medicine` where `e_id`='$aid'");
              ...
              <div class="col-xl-4 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <?php
                      $stmt3=$admin->ret("SELECT * FROM `order` inner join `medicine` on medicine.m_id=order.m_id where `e_id`='$aid'");
